      ...
      <div class="space-y-6 lg:col-span-2">
        ...
        <Card class="overflow-hidden">
          <div class="flex aspect-video items-center justify-center bg-slate-900">
            <button class="flex h-16 w-16 items-center justify-center rounded-full bg-white/20 backdrop-blur transition hover:scale-110 hover:bg-white/30">
        ...
        <Card class="p-6">
          ...
          <h1 class="text-xl font-extrabold tracking-tight text-slate-800">{{ currentLesson.title }}</h1>
          <p class="mt-2 text-sm leading-relaxed text-slate-500">
            Dalam pelajaran ini kamu akan mempelajari huruf hiragana dasar, cara membaca dan menulisnya dengan benar. Perhatikan stroke order agar tulisan kamu rapi dan sesuai standar.
          </p>

          <!-- Content -->
          <div class="mt-5 space-y-3 rounded-2xl bg-slate-50 p-5">
            <h3 class="text-sm font-extrabold text-slate-700">Ringkasan Materi</h3>
        ...
        <div class="flex items-center justify-between">
          ...
          <Button size="sm" @click="completeLesson">Tandai Selesai & Lanjut →</Button>
        </div>
      </div>
...
const lessons = ref([
  { id: 1, title: 'Pengenalan Hiragana', duration: '10 menit', completed: true },
  { id: 2, title: 'Hiragana: あ 〜 さ', duration: '12 menit', completed: true },
  { id: 3, title: 'Hiragana: た 〜 や', duration: '12 menit', completed: false },
  { id: 4, title: 'Hiragana: ら 〜 ん', duration: '10 menit', completed: false },
  { id: 5, title: 'Dakuten & Handakuten', duration: '15 menit', completed: false },
  { id: 6, title: 'Kombinasi Hiragana', duration: '14 menit', completed: false },

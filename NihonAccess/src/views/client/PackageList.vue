<template>
  <div class="mx-auto max-w-6xl space-y-8">
    <!-- Header -->
    <div>
      <Breadcrumb :items="[{ label: 'Dashboard', to: '/client/dashboard' }, { label: 'Beli Paket' }]" />
      <h1 class="mt-3 text-2xl font-extrabold tracking-tight text-slate-800 sm:text-3xl">Pilih Paket Kursus</h1>
      <p class="mt-1 text-sm text-slate-500">Tingkatkan skill bahasa Jepang kamu dengan paket yang tersedia.</p>
    </div>
...
const packages = [
  {
    ...
    duration: '1 bulan',
    popular: false,
    features: ['Hiragana & Katakana', 'Kosakata dasar 300+', 'Akses materi video', 'Latihan interaktif'],
  },
  {
    slug: 'premium-online',
    name: 'Premium Online',
    ...
    duration: '3 bulan',
    popular: true,
    features: ['Semua fitur Basic', 'Kanji 200+', 'Latihan listening', 'Quiz evaluasi', 'Sertifikat'],
  },
  {
    slug: 'private-online',
    name: 'Private Online',
    ...
    duration: '6 bulan',
    popular: false,
    features: ['Semua fitur Premium', 'Mentor pribadi', 'Jadwal fleksibel', 'Konsultasi langsung'],
  },
]
</script>
  ...
  <div class="mx-auto max-w-5xl space-y-8">
    ...
    <div>
      ...
      <p class="mt-1 text-sm text-slate-500">
        Lengkapi pembayaran untuk mengaktifkan paket kursus kamu.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
      ...
      <div class="space-y-6 lg:col-span-2">
        ...
        <Card class="p-6">
          <h2
            class="mb-4 text-sm font-extrabold uppercase tracking-wider text-slate-400"
          >
            Data Peserta
          </h2>
...
const paymentMethods = [
  {
    id: "midtrans",
    name: "Midtrans Snap",
    desc: "Kartu kredit, VA, e-wallet, dll",
    icon: "💳",
  },
  {
    id: "bank-transfer",
...
const handlePay = async () => {
  ...
  setTimeout(() => {
    ...
    router.push({
      ...
      params: { orderId: "NA-001-abcd1234" },

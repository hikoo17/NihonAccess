...
const routes = [
  ...
  {    path: '/teacher',
    ...
    children: [
      ...
      { path: 'courses/create', name: 'TeacherCourseCreate', component: () => import('@/views/teacher/TeacherCourseForm.vue'), meta: { title: 'Tambah Course | Teacher' } },
      { path: 'courses/:id/edit', name: 'TeacherCourseEdit', component: () => import('@/views/teacher/TeacherCourseForm.vue'), props: true, meta: { title: 'Edit Course | Teacher' } },
  ...
  }, 
  {
    ...
    children: [
      ...
      { path: 'tebak-huruf', name: 'client-tebak-huruf', component: () => import('@/views/client/CharacterPlay.vue'), props: true, meta: { title: 'Tebak Huruf | Client' } },
      ...
      { path: 'profile', name: 'client-profile', component: () => import('@/views/client/Profile.vue'), meta: { title: 'Profil Saya | Client' } },
       { path: 'quiz', name: 'client-quiz-list', component: () => import('@/views/client/QuizList.vue'), meta: { title: 'Quiz | Client' } },
      { path: 'quiz/:id', name: 'client-quiz', component: () => import('@/views/client/QuizView.vue'), props: true, meta: { title: 'Kerjakan Quiz | Client' } },
      { path: 'quiz/:id/result', name: 'client-quiz-result', component: () => import('@/views/client/QuizResult.vue'), props: true, meta: { title: 'Hasil Quiz | Client' } },
    ],
  }
